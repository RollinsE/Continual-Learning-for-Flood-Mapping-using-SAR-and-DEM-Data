...
class PSPNet(BaseModel):
    def __init__(self,
        ...
        # Standard BatchNorm keeps the implementation portable across runtime environments.
...
class PSPDenseNet(BaseModel):
    def __init__(self,
        ...
        if not pretrained or in_channels != 3:
            # Use explicit convolution blocks when pretrained input weights are not applicable.
